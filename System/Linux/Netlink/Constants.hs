...
instance Enum MessageFlags where
  toEnum 1 = NLM_F_REQUEST
  toEnum 2 = NLM_F_MULTI
  toEnum 4 = NLM_F_ACK
  toEnum 8 = NLM_F_ECHO
  toEnum 16 = NLM_F_DUMP_INTR
  toEnum 32 = NLM_F_DUMP_FILTERED
  toEnum 256 = NLM_F_CAPPED
  toEnum 512 = NLM_F_ACK_TLVS
  toEnum 1024 = NLM_F_ATOMIC
  toEnum 2048 = NLM_F_APPEND
  fromEnum NLM_F_REQUEST = 1
  fromEnum NLM_F_MULTI = 2
  fromEnum NLM_F_ACK = 4
  fromEnum NLM_F_ECHO = 8
  fromEnum NLM_F_DUMP_INTR = 16
  fromEnum NLM_F_DUMP_FILTERED = 32
  fromEnum NLM_F_CAPPED = 256
  fromEnum NLM_F_NONREC = 256
  fromEnum NLM_F_REPLACE = 256
  fromEnum NLM_F_ROOT = 256
  fromEnum NLM_F_ACK_TLVS = 512
  fromEnum NLM_F_EXCL = 512
  fromEnum NLM_F_MATCH = 512
  fromEnum NLM_F_ATOMIC = 1024
  fromEnum NLM_F_CREATE = 1024
  fromEnum NLM_F_APPEND = 2048
...
instance Enum LinkFlags where
  toEnum 1 = IFF_TUN
  toEnum 2 = IFF_BROADCAST
  toEnum 4 = IFF_DEBUG
  toEnum 8 = IFF_LOOPBACK
  toEnum 16 = IFF_NAPI
  toEnum 32 = IFF_NAPI_FRAGS
  toEnum 64 = IFF_RUNNING
  toEnum 128 = IFF_NOARP
  toEnum 256 = IFF_MULTI_QUEUE
  toEnum 512 = IFF_ALLMULTI
  toEnum 1024 = IFF_DETACH_QUEUE
  toEnum 2048 = IFF_PERSIST
  toEnum 4096 = IFF_MULTICAST
  toEnum 8192 = IFF_ONE_QUEUE
  toEnum 16384 = IFF_AUTOMEDIA
  toEnum 32768 = IFF_DYNAMIC
  toEnum 65536 = IFF_LOWER_UP
  toEnum 131072 = IFF_DORMANT
  toEnum 262144 = IFF_ECHO
  fromEnum IFF_TUN = 1
  fromEnum IFF_UP = 1
  fromEnum IFF_BROADCAST = 2
  fromEnum IFF_TAP = 2
  fromEnum IFF_DEBUG = 4
  fromEnum IFF_LOOPBACK = 8
  fromEnum IFF_NAPI = 16
  fromEnum IFF_POINTOPOINT = 16
  fromEnum IFF_NAPI_FRAGS = 32
  fromEnum IFF_NOTRAILERS = 32
  fromEnum IFF_RUNNING = 64
  fromEnum IFF_NOARP = 128
  fromEnum IFF_MULTI_QUEUE = 256
  fromEnum IFF_PROMISC = 256
  fromEnum IFF_ALLMULTI = 512
  fromEnum IFF_ATTACH_QUEUE = 512
  fromEnum IFF_DETACH_QUEUE = 1024
  fromEnum IFF_MASTER = 1024
  fromEnum IFF_PERSIST = 2048
  fromEnum IFF_SLAVE = 2048
  fromEnum IFF_MULTICAST = 4096
  fromEnum IFF_NOFILTER = 4096
  fromEnum IFF_NO_PI = 4096
  fromEnum IFF_ONE_QUEUE = 8192
  fromEnum IFF_PORTSEL = 8192
  fromEnum IFF_AUTOMEDIA = 16384
  fromEnum IFF_VNET_HDR = 16384
  fromEnum IFF_DYNAMIC = 32768
  fromEnum IFF_TUN_EXCL = 32768
  fromEnum IFF_LOWER_UP = 65536
...
instance Enum RouteNeighStateFlags where
  ...
  toEnum 8 = NUD_DELAY
  toEnum 16 = NUD_PROBE
  toEnum 32 = NUD_FAILED
  toEnum 64 = NUD_NOARP
  toEnum 128 = NUD_PERMANENT
  fromEnum NUD_NONE = 0
  fromEnum NUD_INCOMPLETE = 1
  fromEnum NUD_REACHABLE = 2
  fromEnum NUD_STALE = 4
  fromEnum NUD_DELAY = 8
  fromEnum NUD_PROBE = 16
  fromEnum NUD_FAILED = 32
